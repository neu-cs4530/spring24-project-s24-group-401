...
describe('HangmanArea', () => {
  ...
  describe('[T3.1] Game Update Listeners', () => {
    it('Registers exactly one listener for gameUpdated, gameEnd, and incorrectGuessesLeftChanged events', () => {
    ...
    it('Removes all listeners on unmount', () => {
      ...
      const addedIncorrectGuessesLeftChangedListener = addedListeners.find(
        call => call[0] === 'incorrectGuessesLeftChanged',
      );
      expect(addedIncorrectGuessesLeftChangedListener).toBeDefined();
      ...
      const removedIncorrectGuessesLeftChangedListener = removedListeners.find(
        call => call[0] === 'incorrectGuessesLeftChanged',
      );
      expect(removedIncorrectGuessesLeftChangedListener).toEqual(
        addedIncorrectGuessesLeftChangedListener,
      );
  ...
  describe('[T3.5] Game status text', () => {
    ...
    describe('When the game ends', () => {
      it('And our player won, it displays a toast that they are the winner', () => {
        gameAreaController.mockStatus = 'IN_PROGRESS';
        gameAreaController.mockPlayer1 = ourPlayer;
        gameAreaController.mockPlayer2 = new PlayerController(
          'player y',
      ...
      it('And another player won, it displays a toast that they are the winner', () => {
        gameAreaController.mockStatus = 'IN_PROGRESS';
        gameAreaController.mockPlayer1 = ourPlayer;
        gameAreaController.mockPlayer2 = new PlayerController(
          'player y',
        ...
        gameAreaController.mockGamePlayersById = [ourPlayer.id, gameAreaController.mockPlayer2.id];
        renderHangmanArea();
        ...
        expect(mockToast).toBeCalledWith(
          expect.objectContaining({
            description: 'You lost :(. The winner is ' + gameAreaController.mockPlayer2.id + '!',
          }),
        );
      });
      it('And nobody won, it displays a game lost toast', () => {
        gameAreaController.mockStatus = 'IN_PROGRESS';
        gameAreaController.mockPlayer1 = ourPlayer;
        gameAreaController.mockPlayer2 = new PlayerController(
          'player y',
        ...
        renderHangmanArea();
        gameAreaController.mockWinner = 'NO_WINNER';
        act(() => {
          gameAreaController.emit('gameEnd');
        });
        expect(mockToast).toBeCalledWith(
